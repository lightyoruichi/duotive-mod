...
<head>
	...
	function insertShortcode() {
		...
		shortcode_content = shortcode_content + '<div id="questions-answers">';
			shortcode_content = shortcode_content + '<div id="table-of-content">';	
				shortcode_content = shortcode_content + '<ul>';
					...
					for ( m = 1; m<=number_of_qa;m++)
					{
						...
						shortcode_content = shortcode_content + '<li><a href="#contentitem'+m+'">'+intro_number+'. Here is the place for question no. '+m+'</a></li>';
					}
				shortcode_content = shortcode_content + '</ul>';
			...
			shortcode_content = shortcode_content + '<div id="question-answers-content">';
				...
				for ( m = 1; m<=number_of_qa;m++)
				{
					...
					shortcode_content = shortcode_content + '<div id="contentitem'+m+'">';
						shortcode_content = shortcode_content + '<h6>'+intro_number+'. Here is heading for answer no. '+m+'<a class="top-link" href="#table-of-content">TOP</a></h6>';
						shortcode_content = shortcode_content + 'Here is the place answer content.';
					shortcode_content = shortcode_content + '</div>';
				}			
			shortcode_content = shortcode_content + '</div>';
		shortcode_content = shortcode_content + '</div>';		
