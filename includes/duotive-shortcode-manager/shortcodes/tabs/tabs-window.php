...
<head>
	...
	function insertShortcode() {
		...
		shortcode_content = shortcode_content+'<div class="tabs">';
			shortcode_content = shortcode_content+'<ul>';
				var m = 0;
				for ( m = 0; m<number_of_tabs;m++)
				{
					shortcode_content = shortcode_content+'<li><a href="#tabs-'+m+'">tab title</a></li>';
				}
			shortcode_content = shortcode_content+'</ul>';			
			var n = 0;
			for ( n = 0; n<number_of_tabs;n++)
			{
				shortcode_content = shortcode_content+'<div id="tabs-'+n+'">tab content </div>';
			}			
