...
<head>
	...
	function insertShortcode() {
		...
		shortcode_content = shortcode_content+'<div id="tour">';
			shortcode_content = shortcode_content+'<ul>';
				var m = 1;
				for ( m = 1; m<=number_of_tabs;m++)
				{
					shortcode_content = shortcode_content+'<li><a class="tour-page-title" title="Tour page title no. '+m+'" href="#tour-'+m+'">'+m+'</a></li>';
				}
			shortcode_content = shortcode_content+'</ul>';			
			var n = 1;
			for ( n = 1; n<=number_of_tabs;n++)
			{
				shortcode_content = shortcode_content+'<div id="tour-'+n+'">tour page content </div>';
			}			
