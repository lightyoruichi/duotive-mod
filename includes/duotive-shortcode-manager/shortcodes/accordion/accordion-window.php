...
<head>
	...
	function insertShortcode() {
		...
		shortcode_content = shortcode_content+'<div class="accordion">';
			var i = 0;
			for ( i = 0; i<number_of_accordions;i++)
			{
				shortcode_content = shortcode_content+'<h3><a href="#">accordion title goes here</a></h3>';
				shortcode_content = shortcode_content+'<div>accordion content goes here</div>';				
			}
