<?php
/*
Template Name: Portfolio - Full - 5 Columns Circle
*/
get_header(); ?>
...
<?php $pagination = get_option('portfolio-full-5columns-circle'); ?>
<?php foreach ( $portfolios as $portfolio) :?>
    <?php if ( is_page($portfolio->PAGE)): ?>
            <div id="content-wrapper">
                ...
                ?>      
                	<div class="portfolio-five-column-circle<?php if ( $counter%5 == 0 ) echo ' portfolio-five-column-circle-last'; ?>">
                    ...
                    <?php if ( $counter%5 == 0 ) echo ' <div class="portfolio-two-columns-full-clear"></div>'; ?>
                    <?php $counter++; ?>
                <?php endwhile;endif;?>
