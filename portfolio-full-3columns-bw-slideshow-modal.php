<?php
/*
Template Name: Portfolio - Full - 3 Columns B&W modal
*/
get_header(); ?>
                ...
                ?>      
                	<div class="portfolio-three-columns-full<?php if ( $counter%3 == 0 ) echo ' portfolio-three-columns-full-last'; ?>">
						<?php if ( has_post_thumbnail() ): ?>
                                ...
                                <a class="portfolio-image" href="<?php echo $thumbnail_src; ?>" rel="portfolio[<?php echo $post->ID; ?>]" title="<?php the_title();?>">
                                    <span class="portfolio-icon square-icon-slideshow"></span>                               
                                    <img class="thumbnail blackandwhite" src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=230&amp;w=300&amp;zc=1&amp;q=100&amp;f=2" alt="<?php the_title(); ?>" />
