<?php
/*
Template Name: Portfolio - Sidebar - Slideshow
*/
get_header(); ?>
...
<?php $pagination = get_option('portfolio-sidebar-slideshow'); ?>
<?php foreach ( $portfolios as $portfolio) :?>
    <?php if ( is_page($portfolio->PAGE)): ?>
            <div id="content-wrapper">
                ...
                <?php endif; ?>
	                <?php $transition = get_option('portfolio-sidebar-slideshow-transition'); ?>
                    <?php if ( $transition == '' ) $transition = 'random'; else $transition = get_option('portfolio-sidebar-slideshow-transition'); ?>
                ...
                ?>      
                	<div class="portfolio-one-column-slideshow">
                        <h2>
                        ...
                        <div class="portfolio-slideshow">
							<?php foreach ( $attached_images as $attached_image ): ?>
                                ...
                                <img src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=290&amp;w=630&amp;zc=1&amp;q=100" alt="<?php the_title(); ?>" />                            
                            <?php endforeach; ?>
                        </div>
