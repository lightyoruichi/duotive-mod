<?php
/*
Template Name: Blog - Dual Columns
*/
	get_header();
?>
	<?php $blogs = blog_require();?>
    <?php $pagination = get_option('blogdualcolumnspagination'); ?>
		...
		<?php if ( is_page($blog->PAGE)): ?>
            ...
            <div id="content-wrapper">
                ...
                <div id="content"> 
                    ...
                    ?>
                    <div class="post blog-dual-columns<?php if($counter%2 == 0) echo ' blog-dual-columns-last'; ?>">
                        <h2>
                        ...
                        <?php if ( has_post_thumbnail() ): ?>
                            ...
                            <a class="post-image" href="<?php the_permalink(); ?>" title="<?php the_title();?>">
                                <img src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=140&amp;w=300&amp;zc=1&amp;q=100" alt="<?php the_title(); ?>" />
                            </a>
                        <?php endif; ?>  
                        <?php the_content(''); ?>
                    ...
                    <?php if($counter%2 == 0) echo '<div class="blog-dual-columns-sep"></div>'; ?>
                    <?php $counter++; ?>
                    <?php endwhile;endif;?>
