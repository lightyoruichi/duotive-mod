<?php
/*
Template Name: Portfolio - Sidebar - Square B&W
*/
get_header(); ?>
...
<?php $pagination = get_option('portfolio-sidebar-square'); ?>
<?php foreach ( $portfolios as $portfolio) :?>
    <?php if ( is_page($portfolio->PAGE)): ?>
            <div id="content-wrapper">
                ...
                ?>      
                	<div class="portfolio-one-column-square">
						<?php if ( has_post_thumbnail() ): ?>
                            ...
                            <?php if ( $behaviour == '' || $behaviour == 'Open portfolio item' ) : ?>
                                ...
                                <a class="portfolio-image" href="<?php the_permalink(); ?>" title="<?php the_title();?>">
                                    ...
                                    <img class=" blackandwhite" src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=168&amp;w=168&amp;zc=1&amp;q=100&amp;f=2" alt="<?php the_title(); ?>" />
