...
/** PAGE TEMPLATE **/
/**
 * Template Name: Galery - Duotive Fullwidth - One third
 */
get_header(); ?>
<link rel="stylesheet" type="text/css" media="all" href="<?php bloginfo( 'template_url' ) ?>/css/slideshows/duotive-fullwidth-gallery.css" />                    
	...
	<div id="content-wrapper">
		<?php if ( have_posts() ) while ( have_posts() ) : the_post(); ?>
            <div id="fullWidthGallery" class="fullWidthGallerythird">
                ...
                <ul id="fullWidthGalleryUl" class="fullWidthGallerythird">
					<?php for ( $i = 0; $i < count($attached_images); $i = $i + 3) : ?>
                        <li class="mainlevel third">
                            <ul>
                                ...
                                <?php if ( $thumbnail_src != '' ): ?>
                                    <li>
                                        ...
                                        <a href="<?php echo $thumbnail_src; ?>" rel="gallery[modal]">
                                            ...
                                            <img src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=140&amp;w=316&amp;zc=1&amp;q=100" width="316" height="140" alt="<?php $description = $attached_images[$i]->post_content; if ( $description != '' ) echo $description;?>" />
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if ( $thumbnail_src != '' ): ?>
                                    <li>
                                        <a href="<?php echo $thumbnail_src; ?>" rel="gallery[modal]">
                                            ...
                                            <?php $thumbnail_src = str_replace($website_url,'', $thumbnail_src); ?>                                       
                                            <span class="border"></span>
                                            <img src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=140&amp;w=316&amp;zc=1&amp;q=100" width="316" height="140" alt="<?php $description = $attached_images[$i+1]->post_content; if ( $description != '' ) echo $description;?>" />                                       									
                                        </a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <?php if ( $thumbnail_src != '' ): ?>
                                    <li>
                                        <a href="<?php echo $thumbnail_src; ?>" rel="gallery[modal]">
                                            ...
                                            <?php $thumbnail_src = str_replace($website_url,'', $thumbnail_src); ?>                                       
                                            <span class="border"></span>
                                            <img src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=140&amp;w=316&amp;zc=1&amp;q=100" width="316" height="140" alt="<?php $description = $attached_images[$i+2]->post_content; if ( $description != '' ) echo $description;?>" />
                                        </a>
                                    </li>
                                <?php endif; ?>                                                                                            
                            </ul>
