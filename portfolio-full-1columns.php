<?php
/*
Template Name: Portfolio - Full - 1 Column
*/
get_header(); ?>
...
<?php $pagination = get_option('portfolio-full-1columns'); ?>
<?php foreach ( $portfolios as $portfolio) :?>
    <?php if ( is_page($portfolio->PAGE)): ?>
            <div id="content-wrapper">
                ...
                ?>      
                	<div class="portfolio-one-column-full">
						<?php if ( has_post_thumbnail() ): ?>
                            ...
                            <?php if ( $behaviour == '' || $behaviour == 'Open portfolio item' ) : ?>
                                ...
                                <a class="portfolio-image pageflip" href="<?php the_permalink(); ?>" title="<?php the_title();?>">
                                    ...
                                    <img class="thumbnail" src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=290&amp;w=465&amp;zc=1&amp;q=100" alt="<?php the_title(); ?>" />
                                </a>
                            <?php endif; ?>
