<?php
/*
Template Name: Blog - Modern Layout
*/
	get_header();
?>
	<?php $blogs = blog_require();?>
    <?php $pagination = get_option('blogmodernpagination'); ?>    
                    ...
                    <div class="blog-modern-wrapper">
                        ...
                        <div class="post blog-modern">
                            ...
                            <?php if ( has_post_thumbnail() ): ?>
                                    ...
                                    <?php $thumbnail_src = str_replace($website_url,'', $thumbnail_src); ?>                                  <a class="post-image" href="<?php the_permalink(); ?>" title="<?php the_title();?>">
