<?php
/*
Template Name: Portfolio - Full - 2 Columns Style No.2
*/
get_header(); ?>
...
<?php $pagination = get_option('portfolio-full-2columns-2'); ?>
<?php foreach ( $portfolios as $portfolio) :?>
    <?php if ( is_page($portfolio->PAGE)): ?>
            <div id="content-wrapper">
                ...
                ?>      
                	<div class="portfolio-two-columns-full-type2<?php if ( $counter%2 == 0 ) echo ' portfolio-two-columns-full-type2-last'; ?>">
						<?php if ( has_post_thumbnail() ): ?>
                            ...
                            <?php if ( $behaviour == '' || $behaviour == 'Open portfolio item' ) : ?>                            
                                ...
                                <a class="portfolio-image" href="<?php the_permalink(); ?>" title="<?php the_title();?>">
									<span class="portfolio-icon square-icon-read-more"></span>  
                                    <img class="thumbnail" src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=230&amp;w=230&amp;zc=1&amp;q=100" alt="<?php the_title(); ?>" />
                                </a>
							 <?php endif; ?>
                            <?php if ( $behaviour == 'Open image in modal' ) : ?>
                                <a class="portfolio-image" href="<?php echo $thumbnail_src; ?>" rel="portfolio[modal]" title="<?php the_title();?>">
									<span class="portfolio-icon square-icon-zoom"></span>                               
                                    <img class="thumbnail" src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=230&amp;w=230&amp;zc=1&amp;q=100" alt="<?php the_title(); ?>" />
                                </a>
                            <?php endif; ?>
                            <?php if ( $behaviour == 'Open video in modal' ) : ?>
                                ...
                                <a class="portfolio-image" href="<?php echo $video_url; ?>" rel="portfolio[modal]" title="<?php the_title();?>">
									<span class="portfolio-icon square-icon-video"></span>                                
                                    <img class="thumbnail" src="<?php echo get_bloginfo('template_directory');?>/includes/timthumb.php?src=<?php echo $thumbnail_src; ?>&amp;h=230&amp;w=230&amp;zc=1&amp;q=100" alt="<?php the_title(); ?>" />
                                </a>
                            <?php endif; ?>                                                                                           
                        <?php endif; ?>
